            ...
            <section class="services-section-two">
                ...
                <div class="container">
                            ...
                            <div class="fact-counter-three">
                                {
                                    data?.analytics?.map((analytic, i) => (
                                        ...
                                        <div class="counter-block-three fadeInUp" >
                                            <div class="inner">
                                                <div class="count-box"><span class="count-text" data-speed="3000" data-stop={analytic?.count}>0</span>+</div>
                                    ...
                                    data?.services?.map((service) => (
                                        ...
                                        <div class="service-block-two p-1" >
                                            <div class="inner-box">
                                                ...
                                                <div class="icon-box"><i class={`icon ${service?.iconClass}`}></i></div>
                                                <h5 class="title"><Link to={service?.link}>{service?.title}</Link></h5>
                    ...
                    <div class="bottom-box">
                        <div class="text">{data?.cta?.text}<Link to={data?.cta?.buttonLink} class="theme-btn">{data?.cta?.buttonText}</Link></div>
                    </div>
                </div >
            </section >
        </>
