...
const ManagedServicesForm = ({ ref }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async values => {
            ...
            values = { ...values, service: "Managed Services" };
            try {
                        ...
                        <div className="inner-column">
                            ...
                            <div className="contact-form fadeInLeft">
                                <div className="sec-title">
                                    ...
                                    <h2>Get Free Managed Services Consultation</h2>
                                </div>
                                ...
                                <form id="contact-form" onSubmit={formik.handleSubmit}>
                                    <div className="row">
                                        ...
                                        <div className="form-group col-lg-12">
                                            <textarea id="message" name="message" placeholder="Details of Services you need" {...formik.getFieldProps('message')} />
...
export default ManagedServicesForm;
